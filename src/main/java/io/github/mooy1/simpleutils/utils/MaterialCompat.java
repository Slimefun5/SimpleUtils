package io.github.mooy1.simpleutils.utils;
 ...
 * running server. Keeps SimpleUtils loadable on legacy versions (e.g. 1.8) where
 * modern constants like {@code COMPOSTER} or {@code OAK_TRAPDOOR} are absent.
 */
